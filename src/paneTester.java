...
public class paneTester extends Application{
	...
	public void start(Stage stage) throws Exception {
		...
		Image[] imgBrown = {new Image("images/pikachu.png"), new Image("images/raichu.png")};
		
		String[] namesAqua = {"Squirtle", "Wartortle", "Blastoise"};
		Image[] imgAqua = {new Image("images/squirtle.png"), new Image("images/wartortle.png"), new Image("images/blastoise.png")};
